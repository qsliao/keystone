...
table = { 'table_name': 'keystone_tokens',
        'attribute_definitions': [
            {'attribute_name': 'id', 'attribute_type': 'S'}
            {'attribute_name': 'id', 'attribute_type': 'S'}
            {'attribute_name': 'expires', 'attribute_type': 'N'}
            {'attribute_name': 'extra', 'attribute_type': 'B'} #TODO: check or
             # improve this
            {'attribute_name': 'valid', 'attribute_type': 'S'}#TODO: bool?
            {'attribute_name': 'user_id', 'attribute_type': 'S'}
            {'attribute_name': 'trust_id', 'attribute_type': 'S'}
             ],
        "key_schema": [
